...
async function logic(payload) {
    ...
    const spotlights = top.querySelectorAll(".deslide-item");
    ...
    const recents_wrapper = (_h = DOM.querySelector("#main-content > section:nth-child(2)")) === null || _h === void 0 ? void 0 : _h.querySelector(".film_list-wrap");
    ...
    const new_wrapper = (_t = DOM.querySelector("#main-content > section:nth-child(5)")) === null || _t === void 0 ? void 0 : _t.querySelector(".film_list-wrap");
    ...
    const upcoming_wrapper = (_4 = DOM.querySelector("#main-content > section:nth-child(8)")) === null || _4 === void 0 ? void 0 : _4.querySelector(".film_list-wrap");
